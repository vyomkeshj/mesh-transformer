...
python3 create_finetune_tfrecords.py ./data/sql_data/combined.txt "training_combined" --normalize-with-ftfy --n-repack-epochs 3 --output-dir gs://gpt-j-trainer-sql/data/
...
#python3 slim_model.py --config=./configs/combined_bsize2.json --ckpt-step=201 --f16