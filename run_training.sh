...
python3 ./device_train.py --config=./configs/combined_bsize16.json --tune-model-path=gs://gpt-j-trainer-sql/step_383500/
...
#python3 slim_model.py --config=./configs/combined.json --ckpt-step=201 --f16